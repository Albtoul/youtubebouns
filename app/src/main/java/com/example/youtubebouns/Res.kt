package com.example.youtubebouns
...
import kotlinx.android.synthetic.main.video_iteam.view.*


class Res(
    private val videoList: Array<Array<String>>,
    private val player: YouTubePlayer): RecyclerView.Adapter<Res.VideoViewHolder>(){
